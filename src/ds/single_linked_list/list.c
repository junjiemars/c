...
node_s *
list_append (node_s *head, void *val, node_s *(*new) (void *val))
{
...
void
list_free (node_s *head, void (*free) (node_s *node))
{
...
node_s *
list_find (node_s *head, const void *val,
...
void
list_delete (node_s **head, const void *val,
...
void
list_iterate (node_s *head, void (*iter) (const node_s *node))
{
