...
static void test_bs_int (const void *key, const void *base, size_t n,
                         size_t width);
static void test_bs_str (const void *key, const void *base, size_t n,
                         size_t width);

static void test_bs_iter_int (const void *key, const void *base, size_t n,
                              size_t width);
static void test_bs_iter_str (const void *key, const void *base, size_t n,
                              size_t width);

static void test_bsearch_int (const void *key, const void *base, size_t n,
                              size_t width);
static void test_bsearch_str (const void *key, const void *base, size_t n,
                              size_t width);
...
main (void)
{
  ...
  for (size_t i = 0; i < _nof_ (int_keys); i++)
    {
      test_bs_int (&int_keys[i], int_base, _nof_ (int_base),
                   sizeof (*int_base));
    }
  for (size_t i = 0; i < _nof_ (str_keys); i++)
    {
      test_bs_str (&str_keys[i], str_base, _nof_ (str_base),
                   sizeof (*str_base));
    }
  ...
  for (size_t i = 0; i < _nof_ (int_keys); i++)
    {
      test_bs_iter_int (&int_keys[i], int_base, _nof_ (int_base),
                        sizeof (*int_base));
    }
  for (size_t i = 0; i < _nof_ (str_keys); i++)
    {
      test_bs_iter_str (&str_keys[i], str_base, _nof_ (str_base),
                        sizeof (*str_base));
    }
  ...
  for (size_t i = 0; i < _nof_ (int_keys); i++)
    {
      test_bsearch_int (&int_keys[i], int_base, _nof_ (int_base),
                        sizeof (*int_base));
    }
  for (size_t i = 0; i < _nof_ (str_keys); i++)
    {
      test_bsearch_str (&str_keys[i], str_base, _nof_ (str_base),
                        sizeof (*str_base));
    }
  return 0;
}
    ...
    int (*cmp) (const void *lhs, const void *rhs))
{
  ...
  return bs (key, (char *)base + (mid + 1) * width, n - mid - 1, width, cmp);
}
...
void
test_bs_int (const void *key, const void *base, size_t n, size_t width)
{
  int *found;
...
void
test_bs_str (const void *key, const void *base, size_t n, size_t width)
{
  char **found;
...
void
test_bs_iter_int (const void *key, const void *base, size_t n, size_t width)
{
  int *found;
...
void
test_bs_iter_str (const void *key, const void *base, size_t n, size_t width)
{
  char **found;
...
void
test_bsearch_int (const void *key, const void *base, size_t n, size_t width)
{
  int *found;
...
void
test_bsearch_str (const void *key, const void *base, size_t n, size_t width)
{
  char **found;
