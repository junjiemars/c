...
static void int_types(void);
static void float_types(void);
static void ieee_float(void);
static void ieee_float_special_values(void);
static void ieee_double(void);
...
int_types(void)
{
  ...
  printf(BPRI8, BIT8(x1));

	uint8_t x1s = (uint8_t)(~x1 + 1);
	printf("uint8_t-:  %8c  =  ", x1);
  printf(BPRI8, BIT8(x1s));
  ...
  printf(BPRI16, BIT16(x2));
	...
	printf("uint16_t-: %8"PRIu16"  =  ", x2);
  printf(BPRI16, BIT16(x2s));

	uint32_t x4 = 'A';
	printf("uint32_t:  %8"PRIu32"  =  ", x4);
  printf(BPRI32, BIT32(x4));

	uint64_t x8 = 'A';
	printf("uint64_t:  %8"PRIu64"  =  ", x8);
  printf(BPRI64, BIT64(x8));
}
...
float_types()
{
  ...
  printf(BPRI32, BIT32(x0f.u));

	ufloat32_t x4f =
    { .f = 65.0f };
	printf("float: %16f  =  ", x4f.f);
  printf(BPRI32, BIT32(x4f.u));

	ufloat32_t x4fs =
    { .f = -65.0f };
	printf("float: %16f  =  ", x4fs.f);
  printf(BPRI32, BIT32(x4fs.u));

	ufloat64_t x8f =
    { .f = 65.0 };
	printf("double:%16lf  =  ", x8f.f);
  printf(BPRI64, BIT64(x8f.u));
...
ieee_float()
{
  ...
  printf(BPRI32, BIT32(x4f0.u));

	ufloat32_t x4f2 =
    { .f = 2.0f };
	printf("float: %16f \t=  ", x4f2.f);
  printf(BPRI32, BIT32(x4f2.u));

	ufloat32_t x4f2n =
    { .f = -2.0f };
	printf("float: %16f \t=  ", x4f2n.f);
  printf(BPRI32, BIT32(x4f2n.u));

	printf("  sign     =  " BPRI32, BIT32(x4f2n.layout.sign));
	printf("  exponent =  " BPRI32, BIT32(x4f2n.layout.exponent));
	printf("  mantissa =  " BPRI32, BIT32(x4f2n.layout.mantissa));

	ufloat32_t x4f4 =
    { .f = 4.0f };
	printf("float: %16f \t=  ", x4f4.f);
  printf(BPRI32, BIT32(x4f4.u));

	ufloat32_t x4f8 =
    { .f = 8.0f };
	printf("float: %16f \t=  ", x4f8.f);
  printf(BPRI32, BIT32(x4f8.u));

	ufloat32_t x4f6 =
    { .f = 6.0f };
	printf("float: %16f \t=  ", x4f6.f);
  printf(BPRI32, BIT32(x4f6.u));

	ufloat32_t x4f7 =
    { .f = 7.0f };
	printf("float: %16f \t=  ", x4f7.f);
  printf(BPRI32, BIT32(x4f7.u));

	ufloat32_t x4f1 =
    { .f = 1.0f };
	printf("float: %16f \t=  ", x4f1.f);
  printf(BPRI32, BIT32(x4f1.u));

  ufloat32_t x4f05 =
    { .f = 0.5f };
	printf("float: %16f \t=  ", x4f05.f);
  printf(BPRI32, BIT32(x4f05.u));

  ufloat32_t x4f025 =
    { .f = 0.25f };
	printf("float: %16f \t=  ", x4f025.f);
  printf(BPRI32, BIT32(x4f025.u));

	ufloat32_t x4f075 =
    { .f = 0.75f };
	printf("float: %16f \t=  ", x4f075.f);
  printf(BPRI32, BIT32(x4f075.u));

	ufloat32_t x4f205 =
    { .f = 2.5f };
	printf("float: %16f \t=  ", x4f205.f);
  printf(BPRI32, BIT32(x4f205.u));

	ufloat32_t x4f01 =
    { .f = 0.1f };
	printf("float: %16f \t=  ", x4f01.f);
  printf(BPRI32, BIT32(x4f01.u));
}
...
ieee_float_special_values(void)
{
  ...
  printf(BPRI32, BIT32(x4finf.u));

  ufloat32_t x4finfn =
    { .f = (-1.0f/0.0f) };
	printf("float: %16f \t=  ", x4finfn.f);
  printf(BPRI32, BIT32(x4finfn.u));

  ufloat32_t x4fnan =
    { .f = (0.0f/0.0f) };
	printf("float: %16f \t=  ", x4fnan.f);
  printf(BPRI32, BIT32(x4fnan.u));
#endif

  ufloat32_t x4fmin =
    { .f = FLT_MIN };
	printf("float: %16s \t=  ", "min");
  printf(BPRI32, BIT32(x4fmin.u));
...
ieee_double()
{
  ...
  printf(BPRI64, BIT64(x8f4.u));

	ufloat64_t x8f8 =
    { .f = 8.0 };
	printf("float: %16f \t=  ", x8f8.f);
  printf(BPRI64, BIT64(x8f8.u));

	ufloat64_t x8f6 =
    { .f = 6.0 };
	printf("float: %16f \t=  ", x8f6.f);
  printf(BPRI64, BIT64(x8f6.u));

	ufloat64_t x8f1 =
    { .f = 1.0 };
	printf("float: %16f \t=  ", x8f1.f);
  printf(BPRI64, BIT64(x8f1.u));

	ufloat64_t x8f075 =
    { .f = 0.75 };
	printf("float: %16f \t=  ", x8f075.f);
  printf(BPRI64, BIT64(x8f075.u));

	ufloat64_t x8f25 =
    { .f = 2.5 };
	printf("float: %16f \t=  ", x8f25.f);
  printf(BPRI64, BIT64(x8f25.u));

	ufloat64_t x8f01 =
    { .f = 0.1 };
	printf("float: %16f \t=  ", x8f01.f);
  printf(BPRI64, BIT64(x8f01.u));
}
