...
- [[#memory-bits-and-bytes][Bits and Bytes]]
- [[#memory-basic-types][Basic Types]]
- [[#memory-pointer-basics][Pointer Basics]]
- [[#memory-c-array][C Array]]
- [[#memory-stack-implementation][Stack Implementation]]
- [[#memory-endian][Endian]]
- [[#memory-memory-model][Memory Model]]
...
[[file:src/memory/big-endian.png][Big Endian]]
...
[[file:src/memory/little-endian.png][Little Endian]]
