...
declaration in an outer scope; but only if one of two has [[#language_scope_linkage_no_linkage][no linkage]].
...
- All /declarations/ with [[#language_scope_linkage_no_linkage][no linkage]] are also /definitions/. Other
  /declarations/ are /definitions/ if they have an initializer.

- A [[#language_scope_file_scope][file scope]] variable /declaration/ without the [[#language_scope_linkage_external_linkage][external linkage]]
...
**** /No Linkage/
		 :PROPERTIES:
		 :CUSTOM_ID: language_scope_linkage_no_linkage
		 :END:
...
**** /Internal Linkage/
		 :PROPERTIES:
		 :CUSTOM_ID: language_scope_linkage_internal_linkage
		 :END:
...
**** /External Linkage/
		 :PROPERTIES:
		 :CUSTOM_ID: language_scope_linkage_external_linkage
		 :END:
...
elsewhere (and that has [[#language_scope_linkage_external_linkage][external linkage]]). In general, it is used to
