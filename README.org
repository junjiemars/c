...
*** if vs. ifdef
		:PROPERTIES:
		:CUSTOM_ID: language_if_vs_ifdef
		:END:
...
=#if !defined(identifier)= equals =#ifndef identifier=
#+BEGIN_SRC c
#if !defined(MIN)
