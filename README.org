...
- /scope/: variable defined with auto storage class are local to the
  [[#language_scope_function_scope][function scope]] or [[#language_scope_block_scope][block scope]] inside which they are defined.
...
#+BEGIN_SRC c
register int a[] = { 0x11, 0x22, 0x33, 0x44, };
#+END_SRC
...
- /scope/: [[#language_scope_function_scope][function scope]]
- /duration/: [[#language_duration][automatic]], till the end of [[#language_scope_function_scope][function scope]] in which the
  variable is defined
- /default initial value/: garbage value
...
- [[https://en.wikipedia.org/wiki/Linkage_(software)][Wiki: Linkage]]
- [[https://en.wikipedia.org/wiki/Translation_unit_(programming)][Wiki: Translation unit]]
